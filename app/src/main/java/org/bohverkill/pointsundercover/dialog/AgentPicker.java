...
public class AgentPicker extends DialogFragment {

    AgentPickerListener mCallback;
    ...
    protected void onAttachToContext(Context context) {
        ...
        try {
            this.mCallback = (AgentPickerListener) context;
    ...
    public interface AgentPickerListener {
        void onAgentPicked(int index);
    }
}
